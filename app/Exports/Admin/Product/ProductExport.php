...
class ProductExport implements FromCollection, WithCustomStartCell, WithDrawings, WithHeadings, WithMapping
{
    public function collection() {
        return Product::with(['user', 'image', 'images', 'comments', 'orders', 'productGenders', 'productCategories', 'shippingClass'])->get();
    }
    ...
    public function map($registration): array {
        return [
            ...
            $registration->productGenders->pluck('name'),
