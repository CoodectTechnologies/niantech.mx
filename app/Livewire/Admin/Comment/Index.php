...
class Index extends Component
{
    ...
    protected $queryString = ['searchComment'];
    ...
    public function refused(Comment $comment) {
        ...
        $comment->update();
        $this->dispatch('alert', 'success', __('Comment successfully rejected'));
    }
    public function approved(Comment $comment) {
        $comment->approved = true;
        $comment->update();
        $this->dispatch('alert', 'success', __('Comment successfully approved'));
    }
