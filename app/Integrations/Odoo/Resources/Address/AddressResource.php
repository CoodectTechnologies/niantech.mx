...
namespace App\Integrations\Odoo\Resources\Address;

use App\Integrations\Odoo\Client\Address\AddressClient;
use App\Integrations\Odoo\Dto\Address\AddressDto;
...
class AddressResource
{
    ...
    public function find(int $addressId): array {
        $result = $this->addressClient->getAddresses(domain: [['id', '=', $addressId]]);
    ...
    public function create(array $data): array {
        $addressIds = $this->addressClient->createAddress($data);
    ...
    public function update(int $addressId, array $data): array {
        $updated = $this->addressClient->updateAddress($addressId, $data);
        if ($updated) {
            $address = $this->find($addressId);
