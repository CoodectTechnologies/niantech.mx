        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div class="scroll-y flex-column-fluid px-10 py-10"
                ...
                <div id="#kt_app_body_content"
                    style="background-color:#D5D9E2; font-family:Arial,Helvetica,sans-serif; line-height: 1.5; min-height: 100%; font-weight: normal; font-size: 15px; color: #2F3044; margin:0; padding:1px; width:100%;">
                    <div
                            ...
                            <tbody>
                                        ...
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            <div style="margin-bottom: 10px">
                                                <a href="https://keenthemes.com" rel="noopener" target="_blank">
                                                    <img alt="Logo" src="{{ asset('assets/admin') }}/media/email/logo-1.svg" style="height: 35px" />
                                                </a>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 15px">
                                                <img alt="Logo"
                                                    src="{{ asset('assets/admin') }}/media/email/icon-positive-vote-1.svg" />
                                            </div>
                                            <!--end:Media-->
                                            ...
                                            <div
                                                ...
                                                <p
                                                    style="text-align: center; margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">
                                                    Hey Marcus, thanks for signing up!</p>
                                                <p style="text-align: center; margin-bottom:2px; color:#7E8299">Lots of people make
                                                    mistakes while creating</p>
                                                <p style="text-align: center; margin-bottom:2px; color:#7E8299">paragraphs. Some writers
                                                    just put whitespace in</p>
                                                <p style="text-align: center; margin-bottom:2px; color:#7E8299">their text in random places
                                                </p>
                                            </div>
                                            <!--end:Text-->
                                        ...
                                        <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                                            ...
                                            <div style="display:flex">
                                                ...
                                                <div
                                                    ...
                                                    <img alt="Logo"
                                                        src="{{ asset('assets/admin') }}/media/email/icon-polygon.svg" />
                                ...
                                <tr>
                                    <td align="center" valign="center"
                                        ...
                                        <p
                                            style="text-align: center; color:#181C32; font-size: 16px; font-weight: 600; margin-bottom:9px                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ">
                                            It’s all about customers!</p>
                                        <p style="text-align: center; margin-bottom:2px">Call our customer care number: +31 6 3344 55 56
                                        </p>
                                        <p style="text-align: center; margin-bottom:4px">You may reach us at <a
                                                href="https://devs.keenthemes.com" rel="noopener" target="_blank"
                                                style="font-weight: 600">devs.keenthemes.com</a>.</p>
                                        <p style="text-align: center; margin-bottom:4px">We serve Mon-Fri, 9AM-18AM</p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="center"
                                        ...
                                        <a href="#" style="margin-right:10px"><img alt="Logo"
                                                src="{{ asset('assets/admin') }}/media/email/icon-linkedin.svg" /></a>
                                        <a href="#" style="margin-right:10px"><img alt="Logo"
                                                src="{{ asset('assets/admin') }}/media/email/icon-dribbble.svg" /></a>
                                        <a href="#" style="margin-right:10px"><img alt="Logo"
                                                src="{{ asset('assets/admin') }}/media/email/icon-facebook.svg" /></a>
                                        <a href="#"><img alt="Logo"
                                                src="{{ asset('assets/admin') }}/media/email/icon-twitter.svg" /></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" valign="center"
                                        ...
                                        <p style="text-align: center;"> &copy Copyright KeenThemes.
                                            <a href="https://keenthemes.com" rel="noopener" target="_blank"
