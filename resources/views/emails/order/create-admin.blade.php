@component('mail::message')
    ...
    <p>{{ __('Please be informed that a new order has been placed in your :appname store. Here are the details:', ['appname' => config('app.name')]) }}
    </p>
    ...
    <p>{{ __('Please be sure to process this order in a timely manner and keep the customer updated on the status of the shipment. If you have any questions or need more information, please feel free to contact the customer.') }}
    </p>
