                    ...
                    <div class="product product-widget">
                        <figure class="product-media">
                            <a href="{{ route('ecommerce.product.show', $productViewRecent) }}">
                                <img loading="lazy" src="{{ $productViewRecent->imagePreview() }}"
                                    alt="{{ $productViewRecent->name }}" width="100" height="113" />
                            </a>
                        </figure>
                        <div class="product-details">
                            <h4 class="product-name">
                                <a
                                    href="{{ route('ecommerce.product.show', $productViewRecent) }}">{{ $productViewRecent->name }}</a>
                            </h4>
                            <div class="ratings-container">
                                <div class="ratings-full">
                                    <span class="ratings"
                                        style="width: {{ $productViewRecent->getStarsPercentageAVG() }}%;"></span>
