    ...
    <div class="page-content contact-us">
        <div class="container">
            ...
            <section class="contact-information-section mb-10">
                <div class="row justify-content-center cols-xl-4 cols-md-3 cols-sm-2 cols-1" {{-- data-owl-options="{
                    'items': 3,
                    'nav': false,
                    'dots': true,
                    'loop': false,
                    ...
                    {{-- <div class="icon-box text-center icon-box-primary">
                        ...
                        <div class="icon-box-content">
                            ...
                            <p>
                                <a href="https://maps.app.goo.gl/QywF2pjhVkcGJNQH7" target="_blank" rel="noopener noreferrer">
                                    Leona Vicario 106, Emiliano Zapata, 64430 Monterrey, N.L.
                                </a>
                            </p>
                        </div>
                    </div> --}}
                                ...
                                @foreach($questionAnswers as $questionAnswer)
                                    <div class="card">
                                        <div class="card-header">
                                            <a href="#collapse-{{ $questionAnswer->id }}"
                                                class="expand">{{ $questionAnswer->question }}</a>
                                        </div>
                                        <div id="collapse-{{ $questionAnswer->id }}" class="card-body collapsed">
                                            <p class="mb-0">
