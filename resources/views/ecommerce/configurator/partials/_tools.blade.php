<div class="row d-flex">
    <div class="col-lg-6">
        <h1 x-show="tab == 'tab-component' || tab == 'tab-summary'" class="font-bold text-white">
            {{ $buildStageComponent->name }}</h1>
    ...
    <div class="col-lg-6 d-flex justify-content-lg-end justify-content-sm-start">
        <div class="">
            @auth
                <button wire:click="saveCart" wire:loading.class="load-more-overlay loading"wire:loading.attr="disabled"
                ...
                <button wire:click="restoreCart" wire:loading.class="load-more-overlay loading"wire:loading.attr="disabled"
            ...
            @endauth
            <button wire:click="removeCart" wire:loading.class="load-more-overlay loading"wire:loading.attr="disabled"
            ...
            <button wire:click="shareCart" wire:loading.class="load-more-overlay loading"wire:loading.attr="disabled"
...
<!-- Modal -->
<div wire:ignore.self class="modal fade" id="showModalShareCart" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body d-flex">
                <input type="text" id="linkInput"
                    value="{{ route('ecommerce.configurator.index') }}?shareCart={{ $identifierSaveCartPublic }}"
                    readonly class="form-control">
                <button id="buttonLink" onclick="copyLink()"
                    class="btn btn-secondary text-end">{{ __('Copy link') }}</button>
            </div>
        </div>
    </div>
</div>
