        ...
        <div class="container">
            {{-- <section class="introduce mb-10 pb-10">
                <h2 class="title title-center">
                    {{ __('Titulo a remplazar') }}
                </h2>
                <p class=" mx-auto text-center">
                    {{ $about->information }}
                </p>
                <figure class="br-lg">
                    <img loading="lazy" src="{{ $about->imagePreview() }}" alt="Banner"
            ...
            <section class="customer-service mb-7">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 mb-8">
                        <figure class="br-lg">
                            <img loading="lazy" src="{{ $about->image2Preview() }}" alt="Banner" width="610"
                            ...
                            @foreach($partners as $partner)
                                <div class="image-box-wrapper">
                                    <div class="image-box text-center">
                                        <figure>
                                            <img loading="lazy" src="{{ $partner->imagePreview() }}"
                                                alt="{{ $partner->name }}" width="109" height="105" />
                                        </figure>
                                        <p>{{ $partner->name }}</p>
                                    </div>
                                </div>
