...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/ecommerce') }}/vendor/owl-carousel/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/ecommerce') }}/vendor/animate/animate.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/ecommerce') }}/vendor/magnific-popup/magnific-popup.min.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/ecommerce') }}/vendor/photoswipe/photoswipe.min.css">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/ecommerce') }}/vendor/photoswipe/default-skin/default-skin.min.css">
    @yield('skin')
