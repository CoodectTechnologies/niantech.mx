<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyConfiguratorCompatibility({{ $configuratorCompatibility->id }})"
...
@once
    @push('footer')
        <script>
            function confirmDestroyConfiguratorCompatibility(id) {
                swal.fire({
