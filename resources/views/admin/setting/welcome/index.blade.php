            ...
            <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
                ...
                <div class="card" style="background: #1C325E;">
                    ...
                    <div class="card-body d-flex ps-xl-15">
                        ...
                        <div class="m-0">
                            <!--begin::Title-->
                            <div class="position-relative fs-2x z-index-2 fw-bolder text-light mb-7">
                                ...
                                <br>{{ __('Learn about the different configurations that can be made within the system.') }}
                            </div>
                            <!--end::Title-->
                            <!--begin::Action-->
                            <div class="mb-3">
                                <a href="{{ route('admin.setting.permission') }}"
                                    class="btn btn-danger fw-bold me-2">{{ __('Start') }}</a>
                        ...
                        <!--begin::Action-->
                        <!--begin::Illustration-->
                        <img loading="lazy" src="{{ asset('assets/admin') }}/media/illustrations/sigma-1/9.png"
