    ...
    <div class="card-body pt-0">
        ...
        <div class="mb-2">
            ...
            <input wire:model="translations.meta_title.{{ translatable() }}" type="text"
                class="form-control form-control-sm mb-2 @error('translations.meta_title.{{ translatable() }}') invalid-feedback @enderror"
                placeholder="" />
            <!--end::Input-->
            ...
            <div class="text-muted fs-7">
                {{ __('Set a meta tag title. It is recommended that they be simple and precise keywords.') }}</div>
            <!--end::Description-->
        </div>
        <!--end::Input group-->
        <!--begin::Input group-->
        <div class="mb-2">
            ...
            <textarea wire:model="translations.meta_description.{{ translatable() }}" cols="10" rows="5"
                class="form-control form-control-sm @error('translations.meta_description.{{ translatable() }}') invalid-feedback @enderror">{{ $product->meta_description }}</textarea>
            <!--end::Editor-->
        ...
        <div class="mb-2">
            ...
            <input wire:model="translations.meta_keywords.{{ translatable() }}" type="text"
                class="form-control form-control-sm mb-2 @error('translations.meta_keywords.{{ translatable() }}') invalid-feedback @enderror" />
            <!--end::Input-->
