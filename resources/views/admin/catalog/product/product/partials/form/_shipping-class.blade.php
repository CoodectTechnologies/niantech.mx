    ...
    <div class="card-body pt-0">
        ...
        <div class="mt-10">
            ...
            <div class="mb-0 fv-row">
                    ...
                    <span class="svg-icon svg-icon-2tx svg-icon-info me-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <rect x="11" y="14" width="7" height="2" rx="1"
                                transform="rotate(-90 11 14)" fill="gray"></rect>
                            <rect x="11" y="17" width="2" height="2" rx="1"
                                transform="rotate(-90 11 17)" fill="gray"></rect>
                        </svg>
                    </span>
                    <!--end::Icon-->
                    <!--begin::Wrapper-->
                ...
                <!--begin::Editor-->
                <select wire:model="product.shipping_class_id"
                    class="form-control form-control-sm mb-2 @error('product.shipping_class_id') invalid-feedback @enderror"
                    placeholder="Ejem: 2">
                ...
                <!--end::Editor-->
                @error('product.shipping_class_id')
                    <small class="form-text text-danger" role="alert">{{ $message }}</small>
                @enderror
                <!--begin::Description-->
                <div class="text-muted fs-7">{{ __('You can set a unit type') }}</div>
                <!--end::Description-->
            </div>
            <!--end::Input group-->
        </div>
