    ...
    <div class="card-body pt-0">
                    ...
                    <div class="dropzone dropzone-queue mb-2">
                        ...
                        <div class="dropzone-panel mb-lg-0 mb-2">
                            <label class="dropzone-select btn btn-sm btn-primary me-2"
                                ...
                                {{ __('Choose images') }}
                                <span wire:loading.attr="disabled" wire:target="imagesTmp"
                            ...
                            @if(config('services.vadeto_brands.status') && config('services.vadeto_brands.download_image_product'))
                                <label wire:click.prevent="loadProductImagesBrands" class="dropzone-select btn btn-sm btn-primary me-2">
                                    {{ __('Load images vadeto brands') }}
                                    <span wire:loading.attr="disabled" wire:target="loadProductImagesBrands" wire:loading.class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                </label>
                            @endif
        ...
        <div class="mb-7 row">
            @foreach($imagesTmp as $key => $imageTmp)
                <div wire:key='images-tmp-{{ $key }}' class="col-lg-4 col-sm-4 col-12">
                    ...
                    <div class="mt-1">
                        ...
                        <div class="image-input image-input-outline">
                            ...
                            <span wire:click.prevent="removeImageTemp('{{ $key }}')"
                                ...
                                <i wire:loading.remove wire:target="removeImageTemp('{{ $key }}')"
                                    class="fa-thumbprint fa-light fa-trash fs-2"></i>
            ...
            @foreach($imagesTmpBrands as $key => $imageTmp)
                <div wire:key='images-tmp-brands-{{ $key }}' class="col-lg-4 col-sm-4 col-12">
                    <!--begin::Image input wrapper-->
                    <div class="mt-1">
                        <!--begin::Image input-->
                        <div class="image-input image-input-outline">
                            ...
                            <div
                                ...
                                style="background-image: url('{{ $imageTmp }}')"
                            ></div>
                            <!--end::Preview existing avatar-->
                        </div>
                        <!--end::Image input-->
            ...
            @foreach($productImages as $image)
                <div wire:key='product-image-{{ $image->id }}' class="col-lg-4 col-sm-4 col-12">
                    <!--begin::Image input wrapper-->
                    <div class="mt-1">
                        <!--begin::Image input-->
                        <div class="image-input image-input-outline">
