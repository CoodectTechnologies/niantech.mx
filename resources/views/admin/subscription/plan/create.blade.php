<button type="button" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_plan">
...
<div wire:ignore.self class="modal fade" id="kt_modal_add_plan" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                @livewire('admin.subscription.plan.form', key('create'))
            </div>
        </div>
    </div>
</div>
