<a
    href="#"
    data-bs-toggle="modal" data-bs-target="#kt_modal_update_plan_{{ $plan->id }}"
    class="btn btn-icon btn-bg-light btn-active-color-success btn-sm me-1">
    <i class="ki-outline ki-pencil fs-2"></i>
</a>
 <div wire:ignore.self class="modal fade" id="kt_modal_update_plan_{{ $plan->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                @livewire('admin.subscription.plan.form', ['plan' => $plan], key($plan->id))
            </div>
        </div>
    </div>
</div>
