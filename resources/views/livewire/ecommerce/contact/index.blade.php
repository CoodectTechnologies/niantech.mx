    ...
    <form wire:submit.prevent="sendEmail" class="">
        <div class="row">
            <div class="form-group col-lg-6">
                ...
                <input wire:model="emailWeb.name" required type="text"
            ...
            <div class="form-group col-lg-6">
                ...
                <input wire:model="emailWeb.phone" required type="text"
            ...
            <div class="form-group col-md-6">
                ...
                <input wire:model="emailWeb.subject" required type="text"
            ...
            <div class="form-group col-md-6">
                ...
                <input wire:model="emailWeb.email" required type="email"
        ...
        <div class="form-group">
            ...
            <textarea wire:model="emailWeb.body" required rows="8" class="form-control required"
                placeholder="{{ __('Enter the message') }}"></textarea>
