            ...
            <div class="sticky-sidebar">
                <div class="widget widget-search-form">
                    <div class="widget-body">
                        <form action="{{ route('ecommerce.blog.index') }}" method="GET"
                            class="input-wrapper input-wrapper-inline">
                            <input type="text" name="search" class="form-control"
                                placeholder="{{ __('Search in blog') }}" autocomplete="off" required>
                ...
                <div class="widget widget-categories">
                    ...
                    <ul class="widget-body filter-items search-ul">
                        @foreach($categories as $category)
                            <li>
                                <a href="{{ route('ecommerce.blog.index', ['category' => $category->slug]) }}">{{ $category->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="widget widget-tags">
                    ...
                    <div class="widget-body tags">
                        @foreach($tags as $tag)
                            <a href="{{ route('ecommerce.blog.index', ['tag' => $tag->slug]) }}">{{ $tag->name }}</a>
                        @endforeach
                    </div>
                </div>
            </div>
