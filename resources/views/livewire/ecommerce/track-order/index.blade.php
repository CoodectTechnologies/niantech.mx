                ...
                <div class="col-lg-6">
                    <div class="vendor-search-wrapper open" style="display: block;">
                        <form wire:submit.prevent="trackOrder" class="vendor-search-form">
                            <input wire:model="orderNumber" type="text"
                                class="form-control me-4 bg-white @error('orderNumber') invalid-feedback @enderror"
                                name="orderNumber" id="orderNumber" placeholder="{{ __('Enter your order number') }}">
