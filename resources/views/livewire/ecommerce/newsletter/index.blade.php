<div>
    <div class="footer-newsletter pt-6 pb-6 mt-5">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                    ...
                    <div class="icon-box icon-box-side text-white">
                        ...
                        <div class="icon-box-content">
                            <h4 class="icon-box-title text-white text-uppercase mb-0">
                                {{ __('Subscribe to our Newsletter') }}</h4>
                            <p class="text-white">
                ...
                <div class="col-xl-7 col-lg-6 col-md-9 mt-4 mt-lg-0 ">
                    @if(session()->has('alert-newsletter'))
                        <div
                            class="alert alert-{{ session()->get('alert-type-newsletter') }} alert-simple alert-inline">
                    ...
                    <form wire:submit.prevent="store" class="input-wrapper input-wrapper-inline input-wrapper-rounded">
                        <input wire:model="email" type="email" class="form-control me-2 bg-white" name="email"
                            id="email" placeholder="{{ __('Enter your email address') }}" />
                        <button wire:loading.attr="disabled" wire:target="store" class="btn btn-dark btn-rounded"
                            type="submit">
                            {{ __('Subscribe') }}
