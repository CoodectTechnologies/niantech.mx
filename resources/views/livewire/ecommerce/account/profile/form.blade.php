                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input wire:model="user.name" name="name" required type="text"
                                            class="form-control form-control-md @error('user.name') invalid-feedback @enderror" />
                                        @error('user.name')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input wire:model="user.email" name="email" required type="text"
                                            class="form-control form-control-md @error('user.email') invalid-feedback @enderror" />
                                        @error('user.email')
                                            <small class="form-text text-danger" role="alert">{{ $message }}</small>
                                        @enderror
                                    </div>
