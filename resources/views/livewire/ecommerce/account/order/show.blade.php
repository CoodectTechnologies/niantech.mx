                    ...
                    <div class="order">
                        ...
                        <div class="page-content mb-10 pb-2">
                            <div class="container">
                                ...
                                @if(!in_array($order->status, ['Devolución', 'Cancelado']) && !in_array($order->payment_status, ['Aprobado']))
                                    <div class="text-center mb-5">
                                        <a href="{{ route('ecommerce.checkout.payment', $order) }}"
                                            class="btn btn-primary">Reintentar pago</a>
                                    </div>
                                @endif
                                    ...
                                    <table class="order-table">
                                        ...
                                        <tfoot>
                                            ...
                                            @foreach($order->orderTrackings as $orderTracking)
                                                <tr class="total">
                                                    <th class="border-no">
                                                        {{ __('Guide') }}: {{ $orderTracking->number_tracking }}
                                                        <br>
                                            ...
                                            <div class="col-sm-6 mb-8">
                                                <div class="ecommerce-address address">
                                                    ...
                                                    <address>
                                                        ...
                                                        {{ $order->address->street }}, Código postal:
                                                        {{ $order->address->zip_code }}<br>
                                                        <abbr title="Phone">{{ __('Phone') }}:
                                                            {{ $order->address->phone }}
                                                        </abbr> <br>
                                                        <abbr title="Email">{{ __('Email') }}:
                                                            {{ $order->address->email }}
                                                        </abbr>
                                                    </address>
                                                </div>
                                            ...
                                            <div class="col-sm-6 mb-8">
                                                <div class="ecommerce-address billing-address">
                                                    ...
                                                    <address>
                                                        ...
                                                        {{ $order->billingAddress->colony }},
                                                        {{ $order->billingAddress->street }}, Código postal:
