                ...
                <div class="tab-pane active in" id="account-product-digital">
                    <div class="icon-box icon-box-side icon-box-light">
                        ...
                        <div class="icon-box-content">
                            <h4 class="icon-box-title text-capitalize ls-normal mb-0">{{ $product->getName() }}</h4>
                        </div>
                    </div>
                    <div class="row product-wrapper mb-7 mt-5">

                        <div id="flipbook">
                            <p>Real 3D Flipbook has lightbox feature - book can be displayed in the same page with
                                lightbox effect.</p>
