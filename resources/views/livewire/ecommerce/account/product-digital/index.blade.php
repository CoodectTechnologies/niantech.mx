                ...
                <div class="tab-pane active in" id="account-product-digital">
                    <div class="icon-box icon-box-side icon-box-light">
                        ...
                        <div class="icon-box-content">
                            <h4 class="icon-box-title text-capitalize ls-normal mb-0">{{ __('My products digitals') }}
                            </h4>
                        </div>
                    </div>
                                ...
                                <div class="product text-center">
                                    <figure class="product-media">
                                        <a href="{{ route('ecommerce.account.product-digital.show', $product) }}">
                                            <img loading="lazy" src="{{ $product->imagePreview() }}" alt="Product"
                                                width="295" />
                                        </a>
                                    </figure>
                                    <div class="product-details">
                                        <h3 class="product-name">
                                            <a
                                                href="{{ route('ecommerce.account.product-digital.show', $product) }}">{{ $product->getName() }}</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
