                        ...
                        @foreach($wishlists as $wishlist)
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="{{ route('ecommerce.product.show', $wishlist->model) }}">
                                            <figure>
                                                <img loading="lazy" src="{{ $wishlist->model->imagePreview() }}"
                                                    alt="{{ $wishlist->model->name }}" width="300" height="338">
                                            </figure>
                                        </a>
                                ...
                                <td class="wishlist-action">
                                    <div class="d-lg-flex">
                                        <a href="{{ route('ecommerce.product.show', $wishlist->model) }}"
                                            class="btn btn-quickview btn-outline btn-default btn-rounded btn-sm mb-2 mb-lg-0">{{ __('Show') }}</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
