<div>
            ...
            <div class="card card-flush overflow-hidden h-md-100">
                ...
                <div class="card-header py-5">
                    ...
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark">{{ __('Views') }} {{ $dateStart }} -
                            {{ $dateEnd }}</span>
                    ...
                    <div class="card-toolbar">
                        ...
                        <button type="button" onclick="window.print()"
                            class="btn btn-sm btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click"
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    ...
                    <div class="px-9 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <span class="fs-2hx fw-bolder text-gray-800 me-2 lh-1 ls-n2">{{ $this->viewsTotal }}</span>
                        </div>
                        <!--end::Statistics-->
                    </div>
                    <!--end::Statistics-->
                    <div class="row">
                        <div class="col-lg-12">
                            <!--begin::Chart-->
                            <div wire:ignore id="blog_views_chart" style="height: 300px;"></div>
                            <!--end::Chart-->
                        </div>
                    </div>
                </div>
                                ...
                                <tbody class="fw-bolder text-gray-600">
                                    @foreach($this->commentsNoApproved as $commentNoApproved)
                                        <tr>
                                            ...
                                            <td class=""><a
                                                    href="{{ route('admin.blog.post.show', $commentNoApproved->commentable) }}">{{ $commentNoApproved->commentable->name }}</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    @script
        <script>
            Alpine.data('app', () => ({
                chart: null,
                graphData: @json($graphicPostsViewsData),
                ...
                graphics(){
                    const element = document.getElementById('blog_views_chart');
                    if (!element) {
                        return;
                    }
                    if (this.chart) {
