        ...
        <div class="col-xl-4 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                    style="background-image:url('{{ asset('assets/admin/media/svg/shapes/top-green.png') }}')">
                    <!--begin::Title-->
                ...
                <div class="card-body mt-n20">
                    ...
                    <div class="mt-n20 position-relative">
                        ...
                        <div class="row g-3 g-lg-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">{{ $this->blogPostsCount }}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">{{ $this->ordersCount }}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                            ...
                            @endif
                            <!--begin::Col-->
                            @if(Route::has('admin.blog.post.index') || Route::has('admin.catalog.product.index'))
                                <div class="col-6">
                                    <!--begin::Items-->
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        <!--begin::Symbol-->
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">{{ $this->commentsCount }}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-boldest d-block fs-2qx lh-1 ls-n1 mb-1">{{ $this->emailsWebCount }}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                    ...
                                    <ol
                                        ...
                                        @foreach($this->orders as $order)
                                            <li data-bs-target="#kt_sliders_widget_1_slider"
                                                ...
                                                class="{{ $loop->iteration == 1 ? 'active' : '' }} ms-1"></li>
                                        @endforeach
                                    </ol>
                                        ...
                                        <div class="carousel-item {{ $loop->iteration == 1 ? 'active show' : '' }}">
                                            ...
                                            <div class="mb-1">
                                                <a href="{{ route('admin.order.index') }}"
                                                    class="btn btn-sm btn-secondary">{{ __('View all') }}</a>
                                                <a href="{{ route('admin.order.show', $order) }}"
                                                    class="btn btn-sm btn-primary">{{ __('View order') }}</a>
                                            </div>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Item-->
                                    ...
                                    @foreach($this->blogPosts as $blogPost)
                                        ...
                                        <div class="carousel-item {{ $loop->iteration == 1 ? 'active show' : '' }}">
                                            ...
                                            <div class="d-flex align-items-center mb-9">
                                                ...
                                                <div class="m-0">
                                                    <!--begin::Subtitle-->
                                                    <h4 class="fw-bolder text-gray-800 mb-3">{{ $blogPost->name }}
                                                    </h4>
                                                    <!--end::Subtitle-->
                                                    <!--begin::Items-->
                                                    <div class="d-flex d-grid gap-5">
                                                        ...
                                                        <div class="d-flex flex-column flex-shrink-0 me-4">
                                                            ...
                                                            <span
                                                                ...
                                                                <!--end::Svg Icon-->{{ __('Views') }}:
                                                                {{ $blogPost->viewUniques() }}</span>
                                                            <!--end::Section-->
                                                            <!--begin::Section-->
                                                            <span
                                                                class="d-flex align-items-center text-gray-400 fw-bolder fs-7">
                                                                ...
                                                                <!--end::Svg Icon-->{{ __('Comments') }}:
                                                                {{ $blogPost->comments->count() }}</span>
                                                            <!--end::Section-->
                                                        </div>
                                                        <!--end::Item-->
                                                    </div>
                                            ...
                                            <div class="mb-1">
                                                <a href="{{ route('admin.blog.post.index') }}"
                                                    class="btn btn-sm btn-secondary">{{ __('View all') }}</a>
                                                <a href="{{ route('admin.blog.post.show', $blogPost) }}"
                                                    class="btn btn-sm btn-success">{{ __('View post') }}</a>
                                            </div>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Item-->
                ...
                <div class="card" style="background: #1C325E;">
                    ...
                    <div class="card-body d-flex ps-xl-15">
                        ...
                        <div class="m-0">
                            ...
                            <div class="position-relative fs-2x z-index-2 fw-bolder text-white mb-7">
                                <span class="me-2">{{ __('Welcome to the general dashboard') }},
                                    <span class="position-relative d-inline-block text-danger">
                                        <a
                                            class="text-danger opacity-75-hover">{{ __('you have other dashboards') }}</a>
                                        <!--begin::Separator-->
                                        <span
                            ...
                            <div class="mb-3">
                                @if(Route::has('admin.dashboard.order.index'))
                                    <a href='{{ route('admin.dashboard.order.index') }}'
                                        class="btn btn-danger fw-bold me-2">{{ __('Orders') }}</a>
                                @endif
                                @if(Route::has('admin.dashboard.blog.index'))
                                    <a href="{{ route('admin.dashboard.blog.index') }}"
                                        class="btn btn-danger fw-bold me-2">{{ __('Blog') }}</a>
                                @endif
                                @if(Route::has('admin.dashboard.email-web.index'))
                                    <a href="{{ route('admin.dashboard.email-web.index') }}"
                                        class="btn btn-danger fw-bold me-2">{{ __('Emails') }}</a>
                                @endif
                            </div>
                            <!--begin::Action-->
                        </div>
                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{ route('admin.user.show', ['user' => auth()->user(), 'submodule' => 'logs']) }}"
                                        class="menu-link px-3">{{ __('See all my history') }}</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu 3-->
                        ...
                        @foreach($this->logs as $log)
                            ...
                            <div class="d-flex align-items-center mb-8">
                                ...
                                <div class="flex-grow-1 ms-4">
                                    <a
                                        class="text-gray-800 text-hover-primary fw-bolder fs-6">{{ $log->log_name }}</a>
                                ...
                                <tbody>
                                    @foreach($this->emailsWeb as $emailWeb)
                                        <tr>
                                            <td>
                                                <span
                                                    class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $emailWeb->name }}</span>
                                            </td>
                                            <td>
                                                <a href="mailto:{{ $emailWeb->email }}"
                                                    class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $emailWeb->email }}</a>
                                            </td>
                                            <td>
                                                <a href="tel:{{ $emailWeb->phone }}"
                                                    class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $emailWeb->phone }}</a>
                                            </td>
                                            <td>
                                                <span
                                                    class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $emailWeb->body }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
