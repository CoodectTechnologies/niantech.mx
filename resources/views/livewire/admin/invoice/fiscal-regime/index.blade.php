    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                @include('admin.invoice.fiscal-regime.create')
            </div>
            <!--end::Card toolbar-->
        </div>
        <!--end::Card header-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach($fiscalRegimes as $fiscalRegime)
                            <!--begin::Table row-->
                            <tr>
                                <td>{{ $fiscalRegime->code }}</td>
                                <td>{{ $fiscalRegime->description }}</td>
                                <!--begin::Action=-->
                                <td class="">
                                    @include('admin.invoice.fiscal-regime.edit')
                                    @include('admin.invoice.fiscal-regime.delete')
                                </td>
                                <!--end::Action=-->
                            </tr>
                            <!--end::Table row-->
