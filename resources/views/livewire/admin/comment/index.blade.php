    ...
    <div class="card-header cursor-pointer">
        ...
        <div class="card-title m-0">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <!--end::Svg Icon-->
                <input wire:model="searchComment" type="search" class="form-control form-control-solid w-250px ps-14"
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <div class="d-flex align-items-center flex-grow-1">
                    ...
                    <div class="symbol symbol-45px me-5">
                        <img loading="lazy" src="{{ $comment->imageUserPreview() }}" alt="{{ $comment->name }}" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Info-->
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_update_comment_{{ $comment->id }}">{{ __('Update') }}</a>
                            </li>
                            @if($comment->approved)
                                <li wire:click.prevent="refused({{ $comment->id }})"><a
                                        class="dropdown-item">{{ __('Refuse') }}</a></li>
                            @else
                                <li wire:click.prevent="approved({{ $comment->id }})"><a
                                        class="dropdown-item">{{ __('Approve') }}</a></li>
                            @endif
