    ...
    <div>
        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
                    ...
                    <div class="mt-1">
                        ...
                        <div class="image-input image-input-outline">
                            ...
                            <div class="image-input-wrapper w-200px h-125px"
                                ...
                                @else
                                    style="background-image: url('{{ $brand->imagePreview() }}')" @endif>
                            </div>
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" required wire:model="brand.name"
                    class="form-control form-control-solid @error('brand.name') invalid-feedback @enderror"
                    placeholder="{{ __('Brand name') }}" name="" />
                @error('brand.name')
                    <small class="form-text text-danger" role="alert">{{ $message }}</small>
                @enderror
            </div>
