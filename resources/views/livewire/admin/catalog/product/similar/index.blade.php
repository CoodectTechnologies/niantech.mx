                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-50px overflow-hidden me-3">
                                            <a
                                                href="{{ route('admin.catalog.product.show', $productSimilar->product) }}">
                                                <div class="symbol-label">
                                                    <img loading="lazy"
                                                        src="{{ $productSimilar->product->imagePreview() }}"
                                                        alt="{{ $productSimilar->product->name }}" class="w-100" />
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        ...
                                        <div class="d-flex flex-column">
                                            <a href="{{ route('admin.catalog.product.show', $productSimilar->product) }}"
                                                class="text-gray-800 text-hover-primary mb-1">{{ $productSimilar->product->name }}</a>
