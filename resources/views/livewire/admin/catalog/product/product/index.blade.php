        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <div class="w-100 mw-150px">
                    <!--begin::Select2-->
                    <select wire:model.live="categoryIdFilter" class="form-select form-select-solid">
                ...
                <div class="w-100 mw-150px">
                    <!--begin::Select2-->
                    <select wire:model.live="stockFilter" class="form-select form-select-solid">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a href="{{ route('admin.catalog.product.create') }}"
                                class="dropdown-item">{{ __('New product') }}</a></li>
                        <li><a wire:click="exportProducts" wire:loading.attr="disabled" wire:target="exportProducts"
                                href="#" class="dropdown-item">{{ __('Export products') }}</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_import"
                                class="dropdown-item">{{ __('Import products') }}</a></li>
                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_import_wordpress"
                                class="dropdown-item">{{ __('Import products WoordPress') }}</a></li>
                    </ul>
                </div>
                <!--begin::Button-->
            </div>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach($products as $product)
                            ...
                            <tr>
                                        ...
                                        <div class="symbol symbol-50px overflow-hidden me-3">
                                            <a href="{{ route('admin.catalog.product.show', $product) }}">
                                                <div class="symbol-label">
                                                    <img loading="lazy" src="{{ $product->imagePreview() }}"
                                ...
                                <!--begin::Price=-->
                                <td class="pe-0">
                                    <span class="text-dark">{!! $product->getPriceToString() !!}</span>
                                </td>
                                <!--end::Price=-->
                                <!--begin::Qty=-->
                                <td class="pe-0">
                                    <span class="ms-3">{{ $product->getQuantityTotal() }}</span>
                                </td>
                                <!--end::Qty=-->
                                <!--begin::Comment=-->
                                <td class="pe-0">
                                    ...
                                    @else
                                        <span class="badge badge-light-primary">{{ count($product->comments) }}</span>
                                    @endif
                                </td>
                                <!--end::Comment=-->
                                <!--begin::Status=-->
                                ...
                                <td>
                                    ...
                                    <!--begin::Show-->
                                    <a href="{{ route('admin.catalog.product.edit', $product) }}"
                                        class="btn btn-icon btn-active-light-success w-30px h-30px me-3">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                        <span class="svg-icon svg-icon-3">
