    ...
    <div>
        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" required wire:model="warehouse.name"
                    class="form-control form-control-solid @error('warehouse.name') invalid-feedback @enderror"
                    placeholder="{{ __('warehouse name') }}" name="" />
