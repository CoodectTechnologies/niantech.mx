    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                @include('admin.catalog.warehouse.create')
            </div>
            <!--end::Card toolbar-->
        </div>
        <!--end::Card header-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            <th class="min-w-125px">{{ __('Warehouse') }}</th>
                            <th class="min-w-125px">{{ __('Provider') }}</th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach($warehouses as $warehouse)
                            ...
                            <tr>
                                ...
                                <td>{{ $warehouse->dateToString() }}</td>
                                <!--begin::Action=-->
                                <td class="">
                                    @include('admin.catalog.warehouse.edit')
                                    @include('admin.catalog.warehouse.delete')
                                </td>
                                <!--end::Action=-->
                            </tr>
                            <!--end::Table row-->
