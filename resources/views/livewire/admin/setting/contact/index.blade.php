                ...
                <div class="mb-20 pb-lg-20">
                    ...
                    <div class="fs-4 fw-bold text-gray-700 mb-13">
                        <a href="{{ config('contact.facebook') }}" target="_blank"
                            rel="noopener noreferrer">{{ config('contact.facebook') }}</a>
                    </div>
                    <!--end::Text-->
                    ...
                    <div class="fs-4 fw-bold text-gray-700 mb-13">
                        <a href="{{ config('contact.twitter') }}" target="_blank"
                            rel="noopener noreferrer">{{ config('contact.twitter') }}</a>
                    </div>
                    <!--end::Text-->
                    <!--end::Text-->
                    ...
                    <div class="fs-4 fw-bold text-gray-700 mb-13">
                        <a href="{{ config('contact.instagram') }}" target="_blank"
                            rel="noopener noreferrer">{{ config('contact.instagram') }}</a>
                    </div>
                    <!--end::Text-->
                    <!--end::Text-->
                    ...
                    <!--begin::Text-->
                    <div class="fs-4 fw-bold text-gray-700 mb-13">
                        <a href="{{ config('contact.youtube') }}" target="_blank"
                            rel="noopener noreferrer">{{ config('contact.youtube') }}</a>
                    </div>
                    <!--end::Text-->
                    <!--end::Text-->
                    ...
                    <div class="fs-4 fw-bold text-gray-700 mb-13">
                        <a href="https://wa.me/{{ config('contact.whatsapp') }}" target="_blank"
                            rel="noopener noreferrer">{{ config('contact.whatsapp') }}</a>
                    </div>
                    <!--end::Text-->
                    <!--end::Text-->
                    ...
                    <div class="fs-4 fw-bold text-gray-700 mb-13">
                        <a href="{{ config('contact.linkedin') }}" target="_blank"
                            rel="noopener noreferrer">{{ config('contact.linkedin') }}</a>
                    </div>
                    <!--end::Text-->
                    <!--end::Text-->
