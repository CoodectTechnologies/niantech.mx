<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        ...
        <div class="fv-row mb-7">
            ...
            <input wire:model="moduleWeb.name"
                class="form-control form-control-solid @error('moduleWeb.name') invalid-feedback @enderror"
                placeholder="Ejem: Eventos" name="" />
            @error('moduleWeb.name')
