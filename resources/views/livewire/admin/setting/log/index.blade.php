            ...
            @can('logs')
                <div class="card-toolbar">
                    ...
                    <button wire:click.prevent="optimizeDatabase" type="button" class="btn btn-sm btn-light-primary">
                        ...
                        <!--end::Svg Icon-->
                        {{ __('Delete records older than') }} {{ config('activitylog.delete_records_older_than_days') }}
                        {{ __('days') }}
                            ...
                            <tr>
                                ...
                                <td class="min-w-400px">
                                    ...
                                    <a href="#" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_show_log_{{ $log->id }}"
                                        class="fw-bolder text-gray-900 text-hover-primary">
