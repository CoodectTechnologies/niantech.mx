                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach($shippingZone->states as $estate)
                                        ...
                                        @if($loop->iteration >= 6)
                                            <a href="{{ route('admin.setting.shipping-zone.edit', $shippingZone) }}"
                                                class="badge badge-light-primary fs-7 m-1">+{{ count($shippingZone->states) - 6 }}
                                            </a>
                                            @break
                                        @endif
                                    @endforeach
                                ...
                                <td>
                                    @foreach($shippingZone->shippingClasses as $shippingClass)
                                        <a class="badge badge-light-info fs-7 m-1">{{ $shippingClass->name }}
                                            ${{ number_format($shippingClass->pivot->price, 2) }}</a>
                                    @endforeach
                                </td>
                                <td>
