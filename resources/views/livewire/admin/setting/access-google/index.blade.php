    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                @include('admin.setting.access-google.edit')
            </div>
            <!--end::Card toolbar-->
        </div>
        <!--end::Card header-->
        ...
        <div class="card-body p-5 px-lg-19 py-lg-16">
            <div class="mb-14">
                <div class="mb-15">
                    <h1 class="fs-2x text-dark mb-6">{{ __('Google accesses') }}</h1>
                </div>
                <div class="shadow p-3 mb-5 bg-body rounded">
                    <div class="notice d-flex bg-light-info rounded border-info border border-dashed mb-9 p-6">
                        <div class="d-flex flex-stack flex-grow-1">
                            <div class="fw-bold">
                                <div class="fs-6">
                                    <img width="200" src="{{ asset('assets/admin/media/google/logo.webp') }}"
                                        alt="Mailchimp">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <h2 class="fw-bolder text-dark mb-8">CLIENT SECRET</h2>
                        <div class="fs-4 fw-bold text-gray-700 mb-13">
