<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        <div class="fv-row mb-7">
            ...
            <select wire:model="paypalStatus"
                class="form-control form-control-solid @error('paypalStatus') invalid-feedback @enderror">
        ...
        <div class="fv-row mb-7">
            ...
            <input wire:model="paypalClientId"
                class="form-control form-control-solid @error('paypalClientId') invalid-feedback @enderror"
                placeholder="Ejem: Aaom6OSz_cvoi7C72DFaxwxKuAclEBeXA7ua-j1EenB73XoSBOIYKTcA6_uFbpJc5N46-bXehUdLVeZM"
                name="" />
        ...
        <div wire:ignore class="accordion accordion-icon-toggle" id="kt_accordion_paypal">
            ...
            <div class="mb-5">
                ...
                <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse"
                    data-bs-target="#kt_accordion_2_item_paypal">
                ...
                <div id="kt_accordion_2_item_paypal" class="collapse fs-6 ps-10" data-bs-parent="#kt_accordion_paypal">
                    ...
                    <span
                        class="badge badge-secondary">{{ __('If it does not show you any access, you must first create an application in PayPal.') }}
                    </span>
                </div>
                <!--end::Body-->
            </div>
