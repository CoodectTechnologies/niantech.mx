<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        <div class="fv-row mb-7">
            ...
            <select wire:model="stripeStatus"
                class="form-control form-control-solid @error('stripeStatus') invalid-feedback @enderror">
        ...
        <div wire:ignore class="accordion accordion-icon-toggle" id="kt_accordion_stripe">
            ...
            <div class="mb-5">
                ...
                <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse"
                    data-bs-target="#kt_accordion_2_item_stripe">
                ...
                <div id="kt_accordion_2_item_stripe" class="collapse fs-6 ps-10" data-bs-parent="#kt_accordion_stripe">
                    ...
                    <div class="alert alert-info mt-3">
                        {{ __('After entering your credentials, you must activate the webhook checkout.session.complete.') }}
                        <br>
                        {{ __('To do so, follow the steps below:') }}
                        <ul>
                            <li>{{ __('Click on the following link') }} <a href="https://dashboard.stripe.com/webhooks"
                                    target="_blank">https://dashboard.stripe.com/webhooks</a></li>
                            <li>{{ __("Once inside, look for the button that says 'Add a hotspot' and click it.") }}
                            </li>
                            <li>{{ __("You must enter the following in the 'Connection point URL' field:") }}
                                <strong>{{ route('web.webhook.payment.stripe') }}</strong> </li>
                            <li>{!! __("Click on '+ Select events' and look for <strong>checkout.session.complete</strong> and select it.") !!}</li>
                            <li>{{ __("To finish click on 'Add connection point'. Your stripe configuration is now complete.") }}
                            </li>
                        </ul>
                    </div>
                </div>
