    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        ...
        <div class="fv-row mb-7">
            ...
            <div class="form-check form-switch form-check-custom form-check-solid">
                <input wire:model="active" class="form-check-input @error('active') invalid-feedback @enderror"
        ...
        <div class="fv-row mb-7">
            ...
            <div class="form-check form-switch form-check-custom form-check-solid">
                <input wire:model="budgetActive"
                    class="form-check-input @error('budgetActive') invalid-feedback @enderror" type="checkbox"
                    value="" id="budgetActive" />
