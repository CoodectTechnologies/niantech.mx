<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        ...
        <div class="fv-row mb-7">
            ...
            <select wire:model="state.country_id"
                class="form-control select-custom form-control-solid @error('state.country_id') invalid-feedback @enderror">
        ...
        <div class="fv-row mb-7">
            ...
            <input wire:model="state.name"
                class="form-control form-control-solid @error('state.name') invalid-feedback @enderror"
                placeholder="Ejem: Guadalajara" name="" />
            @error('state.name')
                <small class="form-text text-danger" role="alert">{{ $message }}</small>
            @enderror
        </div>
