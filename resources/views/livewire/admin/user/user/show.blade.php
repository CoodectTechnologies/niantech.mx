    ...
    <div class="d-flex flex-column flex-lg-row">
                        ...
                        @if(Route::has('admin.order.index'))
                            ...
                            <div class="fw-bolder mb-3">{{ __('Orders') }}
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
                                    ...
                                    data-bs-content="Total de ordenes realizadas e ingresos obtenidos."></i>
                            </div>
                            <!--end::Info heading-->
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <div class="tab-content" id="myTabContent" wire:ignore.self>
                ...
                <!--end:::Tab pane-->
                <!--begin:::Tab pane-->
                <div wire:ignore.self class="tab-pane fade {{ $submodule === 'address' ? 'show active' : '' }}" id="kt_user_view_overview_shipping_address" role="tabpanel">
                    @include('admin.user.address.index')
                </div>
                <!--end:::Tab pane-->
                <!--begin:::Tab pane-->
