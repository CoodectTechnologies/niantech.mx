                ...
                @foreach($permissions as $permission)
                    ...
                    <div class="d-flex">
                        ...
                        <div class="form-check form-check-custom form-check-solid">
                            <!--begin::Input-->
                            <input wire:model="userPermissionsDirectArray" class="form-check-input me-3" name=""
                                type="checkbox" value="{{ $permission->name }}"
                                id="kt_modal_update_permission_direct_option_{{ $user->id }}_{{ $permission->id }}" />
                            <!--end::Input-->
                            <!--begin::Label-->
                            <label class="form-check-label"
                                for="kt_modal_update_permission_direct_option_{{ $user->id }}_{{ $permission->id }}">
                    ...
                    <!--end::Input row-->
                    @error('userPermissionsDirectArray')
