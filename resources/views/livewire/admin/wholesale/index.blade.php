    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                <!--begin::Button-->
                <a href="{{ route('admin.wholesale.create') }}" class="btn btn-light-primary">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">{{ __('Currencies') }}</th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach($wholesales as $wholesale)
                            ...
                            <tr>
                                ...
                                <td>{{ count($wholesale->products) }}</td>
                                <td>
                                    @foreach($wholesale->currencies as $currency)
                                ...
                                <td class="">
                                    <!--begin::Update-->
                                    <a href="{{ route('admin.wholesale.edit', $wholesale) }}"
                                    ...
                                    <!--end::Update-->
                                    @include('admin.wholesale.delete')
                                </td>
                                <!--end::Action=-->
                            </tr>
                            <!--end::Table row-->
