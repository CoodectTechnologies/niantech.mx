                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column gap-10">
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="wholesale.name" required type="text"
                                class="form-control mb-2 @error('wholesale.name') invalid-feedback @enderror"
                                placeholder="Ejem: Regla #1" />
                            @error('wholesale.name')
                            ...
                            <tbody>
                                @foreach($wholesaleDetails as $key => $wholesaleDetail)
                                    <tr class="border-bottom border-bottom-dashed">
                                        <td class="pe-7">
                                            <input type="number"
                                                wire:model="wholesaleDetails.{{ $key }}.qty_from"
                                                min="1" class="form-control form-control-solid mb-2"
                                                placeholder="1">
                                            @error('wholesaleDetails.' . $key . '.qty_from')
                                                <span class="form-text text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td class="ps-0">
                                            <input type="number"
                                                wire:model="wholesaleDetails.{{ $key }}.qty_to"
                                                class="form-control form-control-solid" min="1"
                                                placeholder="200">
                                            @error('wholesaleDetails.' . $key . '.qty_to')
                                                <span class="form-text text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td>
                                            <input type="number"
                                                wire:model="wholesaleDetails.{{ $key }}.percentage"
                                                class="form-control form-control-solid" placeholder="10">
                                            @error('wholesaleDetails.' . $key . '.percentage')
                                                <span class="form-text text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td wire:click="removeWholesaleDetail({{ $wholesaleDetail['id'] }}, {{ $key }})"
                                            class="pt-5 text-end">
                                ...
                                @foreach($wholesaleDetailsTMP as $key => $wholesaleDetailInput)
                                    <tr class="border-bottom border-bottom-dashed">
                                        <td class="pe-7">
                                            <input type="number"
                                                wire:model="wholesaleDetailsTMP.{{ $key }}.qty_from"
                                                min="1" class="form-control form-control-solid mb-2"
                                                placeholder="1">
                                            @error('wholesaleDetailsTMP.' . $key . '.qty_from')
                                                <span class="form-text text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td class="ps-0">
                                            <input type="number"
                                                wire:model="wholesaleDetailsTMP.{{ $key }}.qty_to"
                                                class="form-control form-control-solid" min="1"
                                                placeholder="200">
                                            @error('wholesaleDetailsTMP.' . $key . '.qty_to')
                                                <span class="form-text text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td>
                                            <input type="number"
                                                wire:model="wholesaleDetailsTMP.{{ $key }}.percentage"
                                                class="form-control form-control-solid text-end" placeholder="10">
                                            @error('wholesaleDetailsTMP.' . $key . '.percentage')
                                                <span class="form-text text-danger">{{ $message }}</span>
                                            @enderror
                                        </td>
                                        <td wire:click="removeWholesaleDetailTMP({{ $key }})"
                                            class="pt-5 text-end">
                                            <button type="button" class="btn btn-sm btn-icon btn-active-color-danger">
                                                <i class="fa fa-trash"></i>
                                            </button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-5">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select wire:model="wholesale.type" wire:change="changeType()" required
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-check-sm form-check-custom">
                                                    <input wire:model="productsArray" class="form-check-input"
