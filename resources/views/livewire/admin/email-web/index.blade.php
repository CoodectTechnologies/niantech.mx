                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach($emailWebs as $emailWeb)
                            ...
                            <tr>
                                ...
                                <td><a href="mailto:{{ $emailWeb->email }}" target="_blank"
                                        rel="noopener noreferrer"><i class="fa fa-envelope"></i>
                                        {{ $emailWeb->email }}</a></td>
                                <td><i class="fa fa-phone"></i> <a href="tel:{{ $emailWeb->phone }}" target="_blank"
                                        rel="noopener noreferrer">{{ $emailWeb->phone }}</a></td>
                                <td><i class="fab fa-whatsapp"></i> <a href="https://wa.me/+52{{ $emailWeb->phone }}"
                                        target="_blank"
                                        rel="noopener noreferrer">https://wa.me/+52{{ $emailWeb->phone }}</a></td>
