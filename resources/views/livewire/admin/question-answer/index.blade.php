            ...
            <div class="mb-13">
                ...
                <div class="mb-15">
                    ...
                    <p class="fw-bold fs-4 text-gray-600 mb-2">
                        {{ __("You will manage customers' most frequently asked questions by providing answers, so that information is always available to them.") }}
                    </p>
                    <!--end::Text-->
                </div>
                <!--end::Intro-->
                        ...
                        @foreach($questionAnswers as $questionAnswer)
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex align-items-center collapsible py-3 toggle collapsed mb-0"
                                    ...
                                    data-bs-target="#kt_question_answer_{{ $questionAnswer->id }}">
                                    <!--begin::Icon-->
                                ...
                                <div id="kt_question_answer_{{ $questionAnswer->id }}" class="collapse fs-6 ms-1">
                                    <!--begin::Text-->
                                    <div class="mb-4 text-gray-600 fw-bold fs-6 ps-10">{{ $questionAnswer->answer }}
                                    </div>
                                    <!--end::Text-->
                                </div>
                                <!--end::Content-->
