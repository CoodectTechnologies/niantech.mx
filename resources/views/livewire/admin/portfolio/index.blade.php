                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            <th class="min-w-125px">{{ __('Portfolio') }}</th>
                            <th class="min-w-125px">{{ __('Service') }}</th>
                            <th class="min-w-125px">{{ __('Client') }}</th>
                            <th class="min-w-125px">{{ __('Fragment') }}</th>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="{{ route('admin.portfolio.show', $project) }}"
                                            ...
                                            <span class="symbol-label"
                                                style="background-image:url({{ $project->imagePreview() }});"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{ route('admin.portfolio.show', $project) }}"
                                                class="text-gray-800 text-hover-primary fs-5 fw-bolder">{{ $project->name }}</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
