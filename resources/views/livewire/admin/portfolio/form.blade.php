        ...
        <form wire:submit.prevent="{{ $method }}" class="form d-flex flex-column flex-lg-row">
                            ...
                            <div class="mt-1">
                                ...
                                <div class="image-input image-input-outline">
                                    ...
                                    <div class="image-input-wrapper w-200px h-125px"
                                        ...
                                        @else
                                            style="background-image: url('{{ $project->imagePreview() }}')" @endif>
                                    </div>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input wire:model="project.client" type="text"
                                class="form-control mb-2 @error('project.client') invalid-feedback @enderror"
                                placeholder="{{ __('Company or customer') }}" />
                            <!--end::Input-->
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input wire:model="project.link" type="url"
                                class="form-control mb-2 @error('project.link') invalid-feedback @enderror"
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input wire:model="project.date" type="date"
                                class="form-control mb-2 @error('project.date') invalid-feedback @enderror"
                                placeholder="Fecha de proyecto" />
                            <!--end::Input-->
                            @error('project.date')
                                <small class="form-text text-danger" role="alert">{{ $message }}</small>
                            @enderror
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <select wire:model="project.service_id"
                                class="form-select form-select-solid @error('project.service_id') invalid-feedback @enderror">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--begin::Description-->
                            <div class="text-muted fs-7">
                                {{ __('A project name is required and is recommended to be unique.') }}</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div>
                            ...
                            <textarea wire:model="translations.fragment.{{ translatable() }}" required cols="10" rows="5"
                                class="form-control @error('translations.fragment.{{ translatable() }}') invalid-feedback @enderror">{{ $project->fragment }}</textarea>
                            <!--end::Editor-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Input group-->
                        <div wire:ignore wire:key="translations.body">
                            <!--begin::Label-->
                            <label class="form-label required">{{ __('Content') }}</label>
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea wire:model="translations.body.{{ translatable() }}" cols="10" rows="5"
                                class="form-control body @error('translations.body.{{ translatable() }}') invalid-feedback @enderror">{{ $project->body }}</textarea>
                            <!--end::Editor-->
                        </div>
                        <!--end::Input group-->
                                        ...
                                        <div class="image-input image-input-outline">
                                            ...
                                            <span wire:click.prevent="removeImageTemp('{{ $key }}')"
                                                ...
                                                <i wire:loading.remove
                                                    ...
                                                    class="ki-outline ki-pencil fs-2"></i>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10">
                            ...
                            <textarea wire:model="translations.meta_description.{{ translatable() }}" cols="10" rows="5"
                                class="form-control @error('translations.meta_description.{{ translatable() }}') invalid-feedback @enderror">{{ $project->meta_description }}</textarea>
                            <!--end::Editor-->
                        ...
                        <div class="mb-10">
                            ...
                            <!--begin::Description-->
                            <div class="text-muted fs-7">
                                {{ __('These phrases will be used to find this project in the online store search engine. Separate key phrases by adding a comma') }}
