    ...
    <div>
        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="email" required wire:model="newsletter.email"
                    class="form-control form-control-solid @error('newsletter.email') invalid-feedback @enderror"
                    placeholder="Ejem: fulano@gmail.com" name="" />
