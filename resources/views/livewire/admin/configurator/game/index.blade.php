                                    ...
                                    <div class="symbol symbol-circle symbol-100px overflow-hidden me-3">
                                        <a>
                                            <div class="symbol-label">
                                                <img loading="lazy" src="{{ $configuratorGame->imagePreview() }}"
                                                    alt="{{ $configuratorGame->name }}" class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <a
                                            class="text-gray-800 text-hover-primary mb-1">{{ $configuratorGame->name }}</a>
                                    </div>
                                </td>
                                <td>
