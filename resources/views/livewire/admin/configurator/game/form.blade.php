<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
        <!--begin::Input group-->
        <div class="row">
            <div class="col-lg-6" x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                ...
                <div class="mt-1">
                    ...
                    <div class="image-input image-input-outline">
                        ...
                        <div class="image-input-wrapper w-200px h-125px"
                            ...
                            @else
                                style="background-image: url('{{ $configuratorGame->imagePreview() }}')" @endif>
                        </div>
                        ...
                        <!--end::Edit-->
                        @if($imageTmp || $configuratorGame->image)
                            <!--begin::Remove-->
        ...
        <div class="fv-row mb-7">
            ...
            <input required wire:model="configuratorGame.name"
                class="form-control form-control-solid @error('configuratorGame.name') invalid-feedback @enderror"
                placeholder="Ejem: Modern Warfare 3" name="" />
            @error('configuratorGame.name')
                <small class="form-text text-danger" role="alert">{{ $message }}</small>
            @enderror
        </div>
        <!--end::Input group-->
