                                                ...
                                                <ul>
                                                    @foreach($budget['chipsets'] as $chipsetId => $chipset)
                                                        <li>
                                                            ...
                                                            <input
                                                                wire:model="fps.games.{{ $gameId }}.performances.{{ $performanceId }}.budgets.{{ $budgetId }}.chipsets.{{ $chipsetId }}.fps"
                                                                type="number" placeholder="Coloca los FPS">
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            @endforeach
