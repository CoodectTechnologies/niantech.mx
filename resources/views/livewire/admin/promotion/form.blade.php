                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column gap-10">
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.name" required type="text"
                                class="form-control mb-2 @error('promotion.name') invalid-feedback @enderror"
                                placeholder="Ejem: {{ __('Offer to all products') }}" />
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.percentage" required type="number"
                                class="form-control mb-2 @error('promotion.percentage') invalid-feedback @enderror"
                                placeholder="Ejem: 20" />
                            @error('promotion.percentage')
                                <small class="form-text text-danger" role="alert">{{ $message }}</small>
                            @enderror
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.date_start" required type="date"
                                class="form-control mb-2 @error('promotion.date_start') invalid-feedback @enderror"
                                placeholder="" />
                            @error('promotion.date_start')
                                <small class="form-text text-danger" role="alert">{{ $message }}</small>
                            @enderror
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <input wire:model="promotion.date_end" required type="date"
                                class="form-control mb-2 @error('promotion.date_end') invalid-feedback @enderror"
                                placeholder="" />
                            @error('promotion.date_end')
                                <small class="form-text text-danger" role="alert">{{ $message }}</small>
                            @enderror
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row">
                            ...
                            <!--end::Label-->
                            <select required wire:model="promotion.active"
                                class="form-select mb-2 @error('promotion.active') invalid-feedback @enderror">
                                <option value="">{{ __('Select a option') }}</option>
                                <option value="1">{{ __('Active') }}</option>
                                <option value="0">{{ __('Inactive') }}</option>
                            </select>
                            @error('promotion.active')
                                <small class="form-text text-danger" role="alert">{{ $message }}</small>
                            @enderror
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row">
                            <!--begin::Label-->
                            <label
                                class="form-label required">{{ __('Currencies impacted by this promotion') }}</label>
                            <!--end::Label-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-5">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select wire:model="promotion.type" wire:change="changePromotionType()" required
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-5">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select wire:model="promotion.conditional"
                                            @if($promotion->type && $promotion->type != 'Todos') required @endif class="form-select mb-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check form-check-sm form-check-custom">
                                                    <input wire:model="promotionablesArray" class="form-check-input"
