<div>
    ...
    <div wire:ignore x-data="analyticSearchPieChart" id="analytic_search_pie_chart" style="height: 300px;"></div>
    <!--begin::Card-->
    <div class="card">
        <!--begin::Card header-->
    ...
    @script
        <script>
            Alpine.data('analyticSearchPieChart', () => ({
                chart: null,
                graphData: @json($pieChartData),
                ...
                renderChart() {
                    const element = document.getElementById('analytic_search_pie_chart');
                    if (!element) {
                        return;
                    }

                    const labels = Array.isArray(this.graphData.labels) ? this.graphData.labels : [];
                    const series = Array.isArray(this.graphData.series) ? this.graphData.series : [];
                    const colors = Array.isArray(this.graphData.colors) ? this.graphData.colors : [];
