    ...
    <div class="card-body p-lg-20 pb-lg-0">
        ...
        <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="d-flex flex-wrap mb-6">
                            ...
                            <div class="me-9 my-1">
                                ...
                                <!--end::Icon-->
                                <!--begin::Label-->
                                <span class="fw-bolder text-gray-400"><a href="#views">{{ $service->viewUniques() }}
                                        Vistas</a> </span>
                                <!--end::Label-->
                            </div>
                            <!--end::Item-->
                        ...
                        <!--end::Info-->
                        <!--begin::Title-->
                        <a class="text-dark text-hover-primary fs-2 fw-bolder">{{ $service->name }}</a>
                        <!--end::Title-->
                        <!--begin::Container-->
                        <div class="overlay mt-8">
                            <!--begin::Image-->
                            <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                style="background-image:url('{{ $service->imagePreview() }}')"></div>
                            <!--end::Image-->
                        </div>
                        <!--end::Container-->
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                <!--begin::Recent posts-->
                <div class="m-0">
                    <h4 class="text-dark mb-7">Servicios recientes</h4>
                        ...
                        <div class="d-flex flex-stack mb-7">
                            ...
                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                <div class="symbol-label"
                                    style="background-image: url('{{ $recentService->imagePreview() }}')"></div>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Title-->
                            <div class="m-0">
                                <a href="{{ route('admin.service.show', $recentService) }}"
                                    class="text-dark fw-bolder text-hover-primary">{{ $recentService->name }}</a>
                                <span
                                    class="text-gray-600 fw-bold d-block pt-1 fs-7">{{ substr($recentService->fragment, 0, 50) }}...</span>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Item-->
        ...
        <div class="mb-17" id="views">
            <div class="m-0">
                ...
                <div x-data="serviceViewsChart()">
                    <div id="service_views_chart" style="height: 32rem;"></div>
                </div>
            </div>
        </div>
        <!--end::Graphic posts-->
...
@script
    <script>
        Alpine.data('serviceViewsChart', () => ({
            ...
            renderChart() {
                const element = document.getElementById('service_views_chart');
                if (!element) return;
