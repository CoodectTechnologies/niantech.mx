                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Select2-->
                            <select wire:model="order.payment_status"
                                class="form-select mb-2 @error('order.payment_status') invalid-feedback @enderror">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select wire:model="order.status"
                                class="form-select mb-2 @error('order.status') invalid-feedback @enderror">
