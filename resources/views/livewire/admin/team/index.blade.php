                        ...
                        <div class="col mb-9">
                            <div class="text-center">
                                ...
                                <div class="octagon mx-auto mb-2 d-flex w-150px h-150px bgi-no-repeat bgi-size-contain bgi-position-center"
                                    style="background-image:url('{{ $person->imagePreview() }}')"></div>
                                <!--end::Photo-->
                                <!--begin::Person-->
                                <div class="mb-0">
                                    <!--begin::Name-->
                                ...
                                <a href="#" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_update_team_{{ $person->id }}"
                                    class="btn btn-light-success btn-shadow">{{ __('Update') }}</a>
                                <a href="#"
                                    onclick="event.preventDefault(); confirmDestroyTeam({{ $person->id }})"
                                    class="btn btn-light-danger btn-shadow ms-2">{{ __('Delete') }}</a>
                            </div>
