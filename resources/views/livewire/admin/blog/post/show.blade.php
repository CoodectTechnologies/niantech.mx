    ...
    <div class="card-body p-lg-20 pb-lg-0">
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-lg-row-fluid me-xl-15">
                ...
                <div class="mb-17">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="d-flex flex-wrap mb-6">
                            ...
                            <div class="me-9 my-1">
                                ...
                                <!--end::Icon-->
                                <!--begin::Label-->
                                <span class="fw-bolder text-gray-400"><a
                                        href="#comments">{{ $post->comments()->count() }}
                                        {{ __('Comments') }}</a></span>
                                <!--end::Label-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="me-9 my-1">
                                ...
                                <!--end::Icon-->
                                <!--begin::Label-->
                                <span class="fw-bolder text-gray-400"><a href="#views">{{ $post->viewUniques() }}
                                        {{ __('Views') }}</a> </span>
                                <!--end::Label-->
                            </div>
                            <!--end::Item-->
                        ...
                        <a class="text-dark text-hover-primary fs-2 fw-bolder">{{ $post->name }}
                            ...
                            <div class="overlay mt-8">
                                ...
                                <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                    style="background-image:url('{{ $post->imagePreview() }}')"></div>
                                <!--end::Image-->
                            </div>
                            <!--end::Container-->
                    </div>
                    ...
                    @if($post->user)
                        <!--begin::Block-->
                        <div
                            class="d-flex align-items-center justify-content-center border-1 border-dashed card-rounded p-5 p-lg-10 mb-14">
                            <!--begin::Section-->
                            <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-70px symbol-circle mb-2">
                                    <img loading="lazy" src="{{ $post->user->imagePreview() }}" class=""
                                        alt="{{ $post->user->name }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Info-->
                                <div class="mb-0">
                                    <a href="{{ route('admin.user.show', $post->user) }}"
                                        class="text-gray-700 fw-bolder text-hover-primary">{{ $post->user->name }}</a>
                                    @foreach($post->user->roles as $role)
                                        <span
                                            class="text-gray-400 fs-7 fw-bold d-block mt-1">{{ $role->name }}</span>
                                    @endforeach
                                </div>
                                <!--end::Info-->
                            </div>
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                <!--begin::Catigories-->
                <div class="mb-16">
                    <h4 class="text-dark mb-7">{{ __('Categories') }}</h4>
                ...
                <!--begin::Etiquetas-->
                <div class="mb-16">
                    <h4 class="text-dark mb-7">{{ __('Tags') }}</h4>
                ...
                <!--begin::Recent posts-->
                <div class="m-0">
                    <h4 class="text-dark mb-7">{{ __('Recent posts') }}</h4>
                        ...
                        <div class="d-flex flex-stack mb-7">
                            ...
                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                <div class="symbol-label"
                                    style="background-image: url('{{ $recentPost->imagePreview() }}')"></div>
                            </div>
                            <!--end::Symbol-->
                            <!--begin::Title-->
                            <div class="m-0">
                                <a href="{{ route('admin.blog.post.show', $recentPost) }}"
                                    class="text-dark fw-bolder text-hover-primary">{{ $recentPost->name }}</a>
                                <span
                                    class="text-gray-600 fw-bold d-block pt-1 fs-7">{{ substr($recentPost->fragment, 0, 50) }}...</span>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Item-->
        ...
        <!--begin::Graphic posts-->
            ...
            <div class="m-0">
                ...
                <div x-data="postViewsChart()">
                    <div id="post_views_chart" style="height: 32rem;"></div>
                </div>
            </div>
        </div>
        <!--end::Graphic posts-->
...
@script
    <script>
        Alpine.data('postViewsChart', () => ({
            ...
            renderChart() {
                const element = document.getElementById('post_views_chart');
                if (!element) return;
