                ...
                @foreach($posts as $post)
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card-xl-stretch me-md-6">
                            ...
                            <div class="mt-5">
                                <!--begin::Title-->
                                <a href="{{ route('admin.blog.post.show', $post) }}"
                                    class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">{{ $post->name }}</a>
                                <!--end::Title-->
                                <!--begin::Text-->
                                ...
                                @foreach($post->blogCategories as $blogCategory)
                                    <!--begin::Label-->
                                    <span
                                        class="badge badge-light-primary fw-bolder my-2">{{ $blogCategory->name }}</span>
                                    <!--end::Label-->
                                @endforeach
                                <!--begin::Text-->
                                    ...
                                    @if($post->user)
                                        ...
                                        <div class="fs-5 fw-bolder">
                                            <a href="{{ route('admin.user.show', $post->user) }}"
                                                class="text-gray-700">{{ $post->user->name }} </a>
                                        </div>
                                        <!--end::Text-->
                                    @endif
                            ...
                            <div class="text-center">
                                <a href="{{ route('admin.blog.post.edit', $post) }}"
                                    class="btn btn-light-success btn-shadow">{{ __('Update') }}</a>
