                                    ...
                                    @if($package->price)
                                        ...
                                        <div class="text-center">
                                            ...
                                            <span class="fs-3x fw-bolder text-primary"
                                                data-kt-plan-price-month="{{ $package->price }}"
                                                data-kt-plan-price-annual="3399">{{ $package->price }}</span>
                                        </div>
                                        <!--end::Price-->
                                    @endif
                                </div>
                                ...
                                <div class="w-100 mb-10">
                                    @foreach($package->packageFeatures as $packageFeature)
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            <span
                                                class="fw-bold fs-6 text-gray-800 flex-grow-1 pe-3">{{ $packageFeature->name }}</span>
