        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
                    ...
                    <div class="mt-1">
                        ...
                        <div class="image-input image-input-outline">
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                ...
                                @else
                                    style="background-image: url('{{ $testimony->imagePreview() }}')" @endif>
                            </div>
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" required wire:model="translations.name.{{ translatable() }}"
                    ...
                    placeholder="Ingresa el nombre" name="" />
            ...
            <div class="fv-row mb-7">
                <label class="fs-6 fw-bold form-label mb-2">
                    <span class="required">{{ __('Position') }}</span>
                </label>
                <input type="text" required wire:model="translations.position.{{ translatable() }}"
                    class="form-control form-control-solid @error('translations.position.{{ translatable() }}') invalid-feedback @enderror"
                    placeholder="{{ __('Position of the person') }}" name="" />
            ...
            <div class="fv-row mb-7">
                <label class="fs-6 fw-bold form-label mb-2">
                    <span class="required">{{ __('Testimony') }}</span>
                </label>
                <textarea wire:model="translations.body.{{ translatable() }}" required
                    class="form-control form-control-solid @error('translations.body.{{ translatable() }}') invalid-feedback @enderror"
                    cols="30" rows="10" placeholder="{{ __("Enter the person's testimony") }}"></textarea>
