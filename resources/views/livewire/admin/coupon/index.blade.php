                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-100px">{{ __('Date end') }}</th>
                            <th class="min-w-100px">{{ __('Minimum spend') }}</th>
                            <th class="min-w-100px">{{ __('Exclude with promotion') }}</th>
                            <th class="min-w-100px">{{ __('Limit use') }}</th>
                            <th class="min-w-100px">{{ __('Active') }}</th>
                            <th class="min-w-100px">{{ __('Currency') }}</th>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @foreach($coupons as $coupon)
                            ...
                            <tr>
                                ...
                                <td>{{ $coupon->exclude_promotion ? __('Yes') : 'NO' }}</td>
                                ...
                                <td>
                                    @foreach($coupon->currencies as $currency)
