...
class PortfolioSeeder extends Seeder
{
    ...
    public function run() {
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/terramar.webp', 'portfolio/terramar.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/terramar2.webp', 'portfolio/terramar2.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/goguvet.webp', 'portfolio/goguvet.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/goguvet2.webp', 'portfolio/goguvet2.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/goguvet3.webp', 'portfolio/goguvet3.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/globalpest.webp', 'portfolio/globalpest.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/globalpest2.webp', 'portfolio/globalpest2.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/globalpest3.webp', 'portfolio/globalpest3.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/sfericas.webp', 'portfolio/sfericas.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/sfericas2.webp', 'portfolio/sfericas2.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/sfericas3.webp', 'portfolio/sfericas3.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/sfericas4.webp', 'portfolio/sfericas4.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/geasesores.webp', 'portfolio/geasesores.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/geasesores2.webp', 'portfolio/geasesores2.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/geasesores3.webp', 'portfolio/geasesores3.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/cmseguridadyambiente.webp', 'portfolio/cmseguridadyambiente.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/cmseguridadyambiente2.webp', 'portfolio/cmseguridadyambiente2.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/cmseguridadyambiente3.webp', 'portfolio/cmseguridadyambiente3.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/los-arcos-hotel-spa.webp', 'portfolio/los-arcos-hotel-spa.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/los-arcos-hotel-spa2.webp', 'portfolio/los-arcos-hotel-spa2.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/los-arcos-hotel-spa3.webp', 'portfolio/los-arcos-hotel-spa3.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/guitarrafacil.webp', 'portfolio/guitarrafacil.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/guitarrafacil2.webp', 'portfolio/guitarrafacil2.webp')]);
        ...
        // $portfolio->image()->create(['main' => 1, 'url' => mediaManagerSeeder('assets/web/img/portfolio/inglespersonalizado.webp', 'portfolio/inglespersonalizado.webp')]);
        // $portfolio->images()->create(['url' => mediaManagerSeeder('assets/web/img/portfolio/inglespersonalizado2.webp', 'portfolio/guitarrafacil2.webp')]);
    }
}
