...
return new class extends Migration {
    ...
    public function up() {
        Schema::create('configurator_compatibility_product', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('configurator_compatibility_id');
            $table->foreign('configurator_compatibility_id', 'configurator_compatibility_id')->references('id')->on('configurator_stage_product')->onUpdate('cascade')->onDelete('cascade');
