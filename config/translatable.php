...
return [
    ...
    */
    ...
    | El pais debe coincidir con el pais retornado de (Location::get(request()->ip()), estos son usados en los middleware (app\Http\Middleware\CurrencySwitcher.php, app\Http\Middleware\LanguageSwitcher.php)
    |
    */
    'countries' => [
        'Mexico' => [
